...
public class ValidateTicketAsyncTask extends AsyncTask<Void, Void, Void> {
	...
	protected Void doInBackground(Void... params) {
		...
		try {
			...
			requestData.put("bus", BluetoothAdapter.getDefaultAdapter().getAddress());
			requestUrl = MainActivity.SERVER_URL + "/tickets/" + login + "/validate/" + id;
		} catch(Exception e) {
		...
		// Respond to client. Client closes the connection.
		try {
